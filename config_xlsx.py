...
GESTION_CONFIG_XLSX = {
    ...
    # Encabezado XLSX Salida Periodo
    'ENCABEZADO_XLSX_PERIODO': ['MIEMBRO DE CAMPAÑA ID.', 'FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'ESTADO DE ÚLTIMA TAREA', 'ESTADO', 'FECHA DE CIERRE', 'CAMPAIGN MEMBER: ID EMPLEADO', 'ACTIVITIES: EMPLOYEE ID', 'CRO GESTIÓN', 'CONTACTADO'],
    # Nombre de salida XLSX
    'SALIDA_XLSX': 'Detalle_Campanas_CRO'
}
...
PROACTIVA_CONFIG_XLSX = {
    ...
    # Columnas que se utilizaran durante el procesamiento del archivo XLSX
    'COLUMNAS_PROCESO_XLSX': {'FECHA_CREACION': 0, 'NOMBRE_DE_CAMPAÑA': 1, 'ID_EMPLEADO': 2, 'ESTADO': 3, 'POLIZAS_CAMPANAS': 4, 'FECHA_CIERRE': 5, 'NRO_POLIZA': 6, 'EXPIRACION_CORET': 7, 'ESTADO_RETENCION': 8, 'CAMAPAÑA_ID': 9, 'ESTADO_ULTIMA_TAREA': 10},
    ...
    # Encabezado XLSX Salida Reliquidaciones
    'ENCABEZADO_XLSX_REL': ['FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'CAMPAIGN MEMBER: ID EMPLEADO', 'ESTADO', 'PÓLIZAS EN CAMPAÑA', 'FECHA DE CIERRE', 'PÓLIZA: NUMERO DE PÓLIZA', 'FECHA DE EXPIRACIÓN DEL CO-RET', 'ESTADO DE RETENCIÓN', 'MIEMBRO DE CAMPAÑA ID.', 'ESTADO DE ÚLTIMA TAREA', 'FECHA ULT PAGO', 'ESTADO MANDATO', 'FECHA MANDATO', 'PAGA COBRANZA', 'PAGA MANDATO', 'RELIQUIDA COBRANZA', 'RELIQUIDA MANDATO'],
    # Encabezado XLSX Salida Periodo
    'ENCABEZADO_XLSX_PERIODO': ['FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'CAMPAIGN MEMBER: ID EMPLEADO', 'ESTADO', 'PÓLIZAS EN CAMPAÑA', 'FECHA DE CIERRE', 'PÓLIZA: NUMERO DE PÓLIZA', 'FECHA DE EXPIRACIÓN DEL CO-RET', 'ESTADO DE RETENCIÓN', 'MIEMBRO DE CAMPAÑA ID.', 'ESTADO DE ÚLTIMA TAREA', 'FECHA ULT PAGO', 'ESTADO MANDATO', 'FECHA MANDATO', 'CONTACTO CLIENTE', 'CLIENTE UNICO', 'PAGA COBRANZA', 'PAGA MANDATO'],
    # Nombre de salida XLSX
    'SALIDA_XLSX': 'Detalle_Campanas_CoRet_Proactiva'
}
...
REACTIVA_CONFIG_XLSX = {
    ...
    # Nombre de las columnas del encabezado que tendra el archivo
    ...
    # Columnas que se utilizaran durante el procesamiento del archivo XLSX
    'COLUMNAS_PROCESO_XLSX': {'FECHA_CREACION': 0, 'NOMBRE_DE_CAMPAÑA': 1, 'ESTADO': 2, 'POLIZAS_CAMPANA': 3, 'FECHA_CIERRE': 4, 'NRO_POLIZA': 5, 'ESTADO_RETENCION': 6, 'ULTIMA_ACTIVIDAD': 7, 'CAMAPAÑA_ID': 8, 'ESTADO_ULTIMA_TAREA': 9, 'LLAMADA_SALIENTE': 10, 'ID_EMPLEADO': 11},
    ...
    'INBOUND_VALOR': 'VERDADERO',
    'OUTBOUND_VALOR': 'FALSO',

    # Directorio del LOG
    'PATH_LOG': 'REACTIVA\PROCESO_LOG',
    # Encabezado XLSX Salida Periodo
    'ENCABEZADO_XLSX_PERIODO': ['FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'ESTADO', 'PÓLIZAS EN CAMPAÑA', 'FECHA DE CIERRE', 'PÓLIZA: NUMERO DE PÓLIZA', 'ESTADO DE RETENCIÓN', 'ÚLTIMA FECHA DE ACTIVIDAD', 'MIEMBRO DE CAMPAÑA ID.', 'ESTADO DE ÚLTIMA TAREA', 'CONTACTO CLIENTE', 'CLIENTE UNICO', 'ES LLAMADA SALIENTE', 'CAMPAIGN MEMBER: ID EMPLEADO', 'VALIDACIÓN CERTIFICACIÓN', 'ÉXITO REPETIDO', 'ESTADO PÓLIZA', 'ESTADO FINAL'],
    # Nombre de salida XLSX
    'SALIDA_XLSX': 'Detalle_Campanas_CoRet_Reactiva'
}
...
CODM_XLSX = {
    ...
    'ENCABEZADO_XLSX': ['MIEMBRO DE CAMPAÑA ID.', 'FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'ESTADO DE ÚLTIMA TAREA', 'ESTADO', 'FECHA DE CIERRE', 'CAMPAIGN MEMBER: ID EMPLEADO'],
    # Nombre de las columnas de encabezado que tendra el archivo de salida TXT
    'ENCABEZADO_TXT': ['CRR', 'ESTADO_DM', 'ESTADO_UT_DM', 'ID_CAMPANA', 'CAMPANA', 'RUT'],
    # Columnas que se utilizaran durante el procesamiento del archivo XLSX
    'COLUMNAS_PROCESO_XLSX': {'CAMPAÑA_ID': 0, 'FECHA_DE_CREACION': 1, 'NOMBRE_DE_CAMPAÑA': 2, 'ESTADO_UT': 3, 'ESTADO': 4, 'FECHA_CIERRE': 5, 'ID_EMPLEADO': 6},
    # Encabezado XLSX Salida Periodo
    'ENCABEZADO_XLSX_PERIODO': ['MIEMBRO DE CAMPAÑA ID.', 'FECHA DE CREACIÓN', 'CAMPAÑAS: NOMBRE DE LA CAMPAÑA', 'ESTADO DE ÚLTIMA TAREA', 'ESTADO', 'FECHA DE CIERRE', 'CAMPAIGN MEMBER: ID EMPLEADO', 'ESTADO VALIDO', 'CONTACTADO'],
    # Nombre de salida XLSX
    'SALIDA_XLSX': 'Detalle_Campanas_CODM'
}