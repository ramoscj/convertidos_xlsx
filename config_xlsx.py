...
PROACTIVA_CONFIG_XLSX = {
    ...
    # Columnas que se utilizaran durante el procesamiento del archivo XLSX
    'COLUMNAS_PROCESO_XLSX': {'FECHA_CREACION': 0, 'NOMBRE_DE_CAMPAÑA': 1, 'ID_EMPLEADO': 2, 'ESTADO': 3, 'FECHA_CIERRE': 4, 'NRO_POLIZA': 5, 'EXPIRACION_CORET': 6, 'ESTADO_RETENCION': 7, 'CAMAPAÑA_ID': 8, 'ESTADO_ULTIMA_TAREA': 9},
}
